  ...
  <div class="w-full mx-auto p-8 shadow-lg rounded-lg">
    ...
    <div class="space-y-3 mb-4">
      <button
        ...
        class="w-full py-3 px-4 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 border-2 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-400 dark:hover:border-gray-500 rounded-full flex items-center justify-center transition-all duration-200 cursor-pointer font-medium shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
      >
      ...
      <button
        ...
        :disabled="oauthLoading || loading"
        class="w-full py-3 px-4 bg-[#1877F2] hover:bg-[#166FE5] text-white border-2 border-[#1877F2] hover:border-[#166FE5] rounded-full flex items-center justify-center transition-all duration-200 cursor-pointer font-medium shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
      >
    ...
    <div class="relative my-6">
      ...
      <div class="relative flex justify-center text-sm">
        <span class="px-2 bg-white dark:bg-gray-900 text-gray-500">Or register with email</span>
      </div>
    </div>
    ...
    <form class="space-y-4 w-full" @submit.prevent="register">
      ...
      <div class="flex justify-center items-center mt-8 pt-4">
        <UButton
          ...
          class="rounded-full min-w-[150px]"
        >
          <span>Register</span>
        </UButton>
      </div>
