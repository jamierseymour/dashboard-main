...
<template>
  <div class="p-6">
    <div class="space-y-6">
      <!-- Profile Header -->
      <div
        class="flex items-start gap-6 p-6 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700"
      >
        <UAvatar
          :src="avatarUrl"
          :alt="displayName"
      ...
      >
        <div v-if="!isEditing" class="space-y-4">
          ...
          >
            ...
            <p class="text-gray-500 dark:text-gray-400 mb-4">
              Add some information about yourself to help others get to know you
              better.
            </p>
            <UButton
              color="primary"
        ...
        <!-- Edit Form -->
        <UsersEditProfile v-if="isEditing" />
      </div>
    </div>
  </div>
</template>
